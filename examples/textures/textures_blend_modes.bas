...
dim as Image bgImage = LoadImage("resources/cyberpunk_street_background.png")     '' Loaded in CPU memory (RAM)
dim as Texture2D bgTexture = LoadTextureFromImage(bgImage)          '' Image converted to texture, GPU memory (VRAM)

dim as Image fgImage = LoadImage("resources/cyberpunk_street_foreground.png")     '' Loaded in CPU memory (RAM)
dim as Texture2D fgTexture = LoadTextureFromImage(fgImage)          '' Image converted to texture, GPU memory (VRAM)
