...
dim as Image cat = LoadImage("resources/cat.png")             '' Load image in CPU memory (RAM)
...
dim as Font fnt = LoadFont("resources/custom_jupiter_crash.png")

'' Draw over image using custom font
ImageDrawTextEx(@parrots, fnt, "PARROTS & CAT", Vector2(300, 230), fnt.baseSize, -2, WHITE)

UnloadFont(fnt)       '' Unload custom font (already drawn used on image)
...
do while not WindowShouldClose()    '' Detect window close button or ESC key
    ...
    BeginDrawing()
        ...
        DrawTexture(tex, screenWidth/2 - tex.width/2, screenHeight/2 - tex.height/2 - 40, WHITE)
        DrawRectangleLines(screenWidth/2 - tex.width/2, screenHeight/2 - tex.height/2 - 40, tex.width, tex.height, DARKGRAY)
