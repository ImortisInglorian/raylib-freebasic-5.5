...
do while not WindowShouldClose()    '' Detect window close button or ESC key
    ...
    BeginDrawing()
        ...
        DrawTriangle(Vector2(screenWidth/4.0f *3.0f, 80.0f), _
                     Vector2(screenWidth/4.0f *3.0f - 60.0f, 150.0f), _
                     Vector2(screenWidth/4.0f *3.0f + 60.0f, 150.0f), VIOLET)

        DrawTriangleLines(Vector2(screenWidth/4.0f*3.0f, 160.0f), _
                          Vector2(screenWidth/4.0f*3.0f - 20.0f, 230.0f), _
