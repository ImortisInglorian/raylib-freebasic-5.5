...
dim as long logoPositionX = screenWidth/2 - 128
dim as long logoPositionY = screenHeight/2 - 128

dim as long framesCounter = 0
dim as long lettersCount = 0

dim as long topSideRecWidth = 16
dim as long leftSideRecHeight = 16

dim as long bottomSideRecWidth = 16
dim as long rightSideRecHeight = 16
...
do while not WindowShouldClose()    '' Detect window close button or ESC key
    ...
    BeginDrawing()
        ...
        if state = 0 then
            if (framesCounter / 15) mod 2 then DrawRectangle(logoPositionX, logoPositionY, 16, 16, BLACK)
        elseif state = 1 then
