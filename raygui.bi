...
*           - int *LoadCodepoints(byval text as const zstring ptr, int *count)    '' -- GuiLoadStyle(), required to load required font codepoints list
...
type as long GuiTextAlignmentVertical
enum
    TEXT_ALIGN_TOP = 0
    TEXT_ALIGN_MIDDLE
    TEXT_ALIGN_BOTTOM
...
type as long GuiControlProperty
enum
...
type as long GuiDefaultProperty
enum
...
'' Toggle/ToggleGroup
type as long GuiToggleProperty
enum
    GROUP_PADDING = 16         '' ToggleGroup separation between toggles
end enum

'' Slider/SliderBar
type as long GuiSliderProperty
enum
...
'' ProgressBar
type as long GuiProgressBarProperty
enum
    PROGRESS_PADDING = 16      '' ProgressBar internal padding
end enum

'' ScrollBar
type as long GuiScrollBarProperty
enum
...
'' CheckBox
type as long GuiCheckBoxProperty
enum
    CHECK_PADDING = 16          '' CheckBox internal check padding
end enum

'' ComboBox
type as long GuiComboBoxProperty
enum
...
'' DropdownBox
type as long GuiDropdownBoxProperty
enum
...
type as long GuiTextBoxProperty
enum
    TEXT_READONLY = 16         '' TextBox in read-only mode: 0-text editable, 1-text no-editable
end enum

'' Spinner
type as long GuiSpinnerProperty
enum
...
'' ListView
type as long GuiListViewProperty
enum
...
'' ColorPicker
type as long GuiColorPickerProperty
enum
...
declare sub GuiSetState(byval state as long)            '' Set gui state (global state)
declare function GuiGetState() as long                  '' Get gui state (global state)

'' Font set/get functions
declare sub GuiSetFont(byval font as Font)              '' Set gui custom font (global state)
declare function GuiGetFont() as Font                   '' Get gui custom font (global state)

'' Style set/get functions
declare sub GuiSetStyle(byval control as long, byval property as long, byval value as long) '' Set one style property
declare function GuiGetStyle(byval control as long, byval property as long) as long         '' Get one style property
...
declare sub GuiSetTooltip(byval tooltip as zstring ptr) '' Set tooltip string
...
#if not defined(RAYGUI_NO_ICONS)
...
declare function GuiLoadIcons(byval fileName as const zstring ptr, byval loadIconsName as RLBOOL) as ubyte ptr ptr                      '' Load raygui icons file (.rgi) into internal icons data
declare sub GuiDrawIcon(byval iconId as long, byval posX as long, byval posY as long, byval pixelSize as long, byval color as RLColor)  '' Draw icon using pixel size at specified position
#endif
...
declare function GuiGroupBox(byval bounds as Rectangle, byval title as const zstring ptr) as long                                                                                          '' Group Box control with text name
declare function GuiLine(byval bounds as Rectangle, byval title as const zstring ptr) as long                                                                                              '' Line separator control, could contain text
declare function GuiPanel(byval bounds as Rectangle, byval title as const zstring ptr) as long                                                                                            '' Panel control, useful to group controls
declare function GuiTabBar(byval bounds as Rectangle, byval title as const zstring ptr ptr, byval count as long, byval active as long ptr) as long                                         '' Tab Bar control, returns TAB to be closed or -1
declare function GuiScrollPanel(byval bounds as Rectangle, byval title as const zstring ptr, byval content as Rectangle, byval scroll as Vector2 ptr, byval view as Rectangle ptr) as long '' Scroll Panel control

'' Basic controls set
declare function GuiLabel(byval bounds as Rectangle, byval text as const zstring ptr) as long                                            '' Label control
...
declare function GuiLabelButton(byval bounds as Rectangle, byval text as const zstring ptr) as long                                      '' Label button control, returns true when clicked
declare function GuiToggle(byval bounds as Rectangle, byval text as const zstring ptr, byval active as long ptr) as long                             '' Toggle Button control
declare function GuiToggleGroup(byval bounds as Rectangle, byval text as const zstring ptr, byval active as long ptr) as long                         '' Toggle Group control
declare function GuiToggleSlider(byval bounds as Rectangle, byval text as const zstring ptr, byval active as long ptr) as long                        '' Toggle Slider control
declare function GuiCheckBox(byval bounds as Rectangle, byval text as const zstring ptr, byval checked as long ptr) as long                          '' Check Box control, returns true when active
declare function GuiComboBox(byval bounds as Rectangle, byval text as const zstring ptr, byval active as long ptr) as long                            '' Combo Box control

declare function GuiDropdownBox(byval bounds as Rectangle, byval text as const zstring ptr, byval active as long ptr, byval editMode as RLBOOL) as long          '' Dropdown Box control
declare function GuiSpinner(byval bounds as Rectangle, byval text as const zstring ptr, byval value as long ptr, byval minValue as long, byval maxValue as long, byval editMode as RLBOOL) as long '' Spinner control
declare function GuiValueBox(byval bounds as Rectangle, byval text as const zstring ptr, byval value as long ptr, byval minValue as long, byval maxValue as long, byval editMode as RLBOOL) as long '' Value Box control, updates input text with numbers
declare function GuiValueBoxFloat(byval bounds as Rectangle, byval text as const zstring ptr, byval textValue as zstring ptr, byval value as single ptr, byval editMode as RLBOOL) as long '' Value box control for float values
declare function GuiTextBox(byval bounds as Rectangle, byval text as zstring ptr, byval textSize as long, byval editMode as RLBOOL) as long                   '' Text Box control, updates input text

declare function GuiSlider(byval bounds as Rectangle, byval textLeft as const zstring ptr, byval textRight as const zstring ptr, byval value as single ptr, byval minValue as single, byval maxValue as single) as long '' Slider control
declare function GuiSliderBar(byval bounds as Rectangle, byval textLeft as const zstring ptr, byval textRight as const zstring ptr, byval value as single ptr, byval minValue as single, byval maxValue as single) as long '' Slider Bar control
declare function GuiProgressBar(byval bounds as Rectangle, byval textLeft as const zstring ptr, byval textRight as const zstring ptr, byval value as single ptr, byval minValue as single, byval maxValue as single) as long '' Progress Bar control
...
declare function GuiGrid(byval bounds as Rectangle, byval text as const zstring ptr, byval spacing as single, byval subdivs as long, byval mouseCell as Vector2 ptr) as long '' Grid control

'' Advance controls set
declare function GuiListView(byval bounds as Rectangle, byval text as const zstring ptr, byval scrollIndex as long ptr, byval active as long ptr) as long          '' List View control
...
declare function GuiTextInputBox(byval bounds as Rectangle, byval title as const zstring ptr, byval value as single ptr, byval minValue as single, byval maxValue as single, byval text as zstring ptr, byval textMaxSize as long, byval secretViewActive as long ptr) as long '' Text Input Box control, ask for text, supports secret
declare function GuiColorPicker(byval bounds as Rectangle, byval text as const zstring ptr, byval color as RLColor ptr) as long                        '' Color Picker control (multiple color controls)
declare function GuiColorPanel(byval bounds as Rectangle, byval text as const zstring ptr, byval color as RLColor ptr) as long                         '' Color Panel control
declare function GuiColorBarAlpha(byval bounds as Rectangle, byval text as const zstring ptr, byval alpha as single ptr) as long                      '' Color Bar Alpha control
declare function GuiColorBarHue(byval bounds as Rectangle, byval text as const zstring ptr, byval value as single ptr) as long                        '' Color Bar Hue control
declare function GuiColorPickerHSV(byval bounds as Rectangle, byval text as const zstring ptr, byval colorHsv as Vector3 ptr) as long                '' Color Picker control that avoids conversion to RGB on each call (multiple color controls)
declare function GuiColorPanelHSV(byval bounds as Rectangle, byval text as const zstring ptr, byval colorHsv as Vector3 ptr) as long                 '' Color Panel control that updates Hue-Saturation-Value color value, used by GuiColorPickerHSV()
''----------------------------------------------------------------------------------------------------------

#if  not defined(RAYGUI_NO_ICONS)

#if  not defined(RAYGUI_CUSTOM_ICONS)
''----------------------------------------------------------------------------------
'' Icons enumeration
''----------------------------------------------------------------------------------
type as long GuiIconName
enum
    ICON_NONE                     = 0
